        ...
        <div className="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-10 max-w-xs mx-auto md:max-w-none -m-5">
            ...
            <div className="text-center p-5">
              ...
              <div className="font-bold text-slate-100 mb-1">Passionate Innovators</div>
              <p className="text-sm text-slate-400">We're looking for visionaries who bring excitement and ingenuity to solving complex challenges.</p>
            </div>
            {/* Block #2 */}
            <div className="text-center p-5">
              <div className="inline-flex items-center justify-center h-12 w-12 rounded-full border border-transparent [background:linear-gradient(theme(colors.slate.800),_theme(colors.slate.800))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] mb-3">
              ...
              <div className="font-bold text-slate-100 mb-1">Dynamic Team Players</div>
              <p className="text-sm text-slate-400">If you thrive in collaborative environments and love making a tangible impact, we want you.</p>
            </div>
            {/* Block #3 */}
            <div className="text-center p-5">
              <div className="inline-flex items-center justify-center h-12 w-12 rounded-full border border-transparent [background:linear-gradient(theme(colors.slate.800),_theme(colors.slate.800))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] mb-3">
              ...
              <div className="font-bold text-slate-100 mb-1">Goal-Driven Performers</div>
              <p className="text-sm text-slate-400">Join our pursuit of excellence. We celebrate those who set ambitious goals and relish in achieving them.</p>
            </div>
          </div>
