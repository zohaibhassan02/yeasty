      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">Simplify Your Service, Magnify Your Impact</div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Elevate Your Operations with Yeasti</h2>
            <p className="text-lg text-slate-400 mb-8">Step into the future of the beverage industry with Yeasti—where simplicity meets efficiency. Our platform provides you with user-friendly design, automated discount systems, and innovative menu options to elevate your customer’s experience. Embrace the ease of updating your digital menu and witness a seamless operational flow. Get started with Yeasti and turn your service into an unforgettable experience.</p>
            <div>
