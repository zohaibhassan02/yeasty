          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                  A <strong className="text-slate-300 font-medium">specialized platform</strong> designed with the needs of bars, breweries, and distributors in mind, providing targeted solutions without unnecessary extras.
                </p>
              </div>
            </div>
            {/* Card #2 */}
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                Reduce the time spent on routine tasks with <strong className="text-slate-300 font-medium">AI-driven</strong> automation that manages inventory, sales trends, and customer relationships efficiently.
                </p>
              </div>
            </div>
            {/* Card #3 */}
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                Clear, no-surprise pricing ensures you get exactly what you pay for — <strong className="text-slate-300 font-medium"> no hidden fees</strong>, no forced upgrades, and absolutely no unexpected charges on your bill.
                </p>
              </div>
            </div>
            {/* Card #4 */}
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                Reliable support whenever you need it, with a promise of <strong className="text-slate-300 font-medium">timely and helpful</strong> assistance through email or live chat, ensuring no question goes unanswered
                </p>
              </div>
            </div>
            {/* Card #5 */}
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                Regular updates and new features developed based on industry trends and user feedback, ensuring a platform that <strong className="text-slate-300 font-medium">evolves</strong> with your business.
                </p>
              </div>
            </div>
            {/* Card #6 */}
            <div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                Whether you're a startup microbrewery or a large-scale distributor, our platform <strong className="text-slate-300 font-medium">scales</strong> with you, ensuring you have the right tools at every stage of growth.
                </p>
              </div>
            </div>
          </div>
