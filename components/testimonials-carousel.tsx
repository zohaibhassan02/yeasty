                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Menu Customization</div>
                        <div className="text-slate-400 mb-3">Personalize your digital menu in real-time. Tailor every aspect, from beers on tap to seasonal specials, ensuring your customers always have the latest selections at their fingertips.</div>
                      </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Inventory Tracking</div>
                        <div className="text-slate-400 mb-3">Effortless inventory management ensures you know what's in stock, what's running low, and what's out, keeping your offerings up-to-date and minimizing waste.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="#0">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Promotions Management</div>
                        <div className="text-slate-400 mb-3">Enhance your revenue with smart, easily customizable promotions. From happy hour specials to event-driven discounts, manage and activate offers right from your dashboard.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="#0">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Seamless Updates</div>
                        <div className="text-slate-400 mb-3">Change prices, update descriptions, or add new items to your menu seamlessly. Our system is designed for quick edits that immediately reflect on your digital displays.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="#0">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Menu Mastery</div>
                        <div className="text-slate-400 mb-3">Easily craft and distribute polished print menus or generate dynamic QR codes that lead guests to an up-to-date online selection of your offerings for their browsing pleasure.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="#0">Learn More <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span></a>
                      </div>
