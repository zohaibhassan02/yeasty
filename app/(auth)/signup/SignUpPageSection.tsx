...
export default function SignUpPageSection() {
  ...
  const SignUpHandler = async (): Promise<void> => {
    if (
      formFields.companeyName === '' ||
      formFields.fullName === '' ||
      formFields.hearAbout === '' ||
      formFields.email === '' ||
      formFields.password === ''
    ) {
      toast.error('Please enter your information first');
    } else {
      setFormFields({ ...formFields, loading: true });
      try {
        const response = await signUp({
          fullName: formFields.fullName,
          email: formFields.email,
          password: formFields.password,
          companyName: formFields.companeyName,
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                id="full-name" className="form-input w-full" type="text" placeholder="E.g., Mark Rossi" required />
            </div>
            <div>
              ...
              <input
                ...
                id="email" className="form-input w-full" type="email" placeholder="markrossi@company.com" required />
            </div>
            <div>
              ...
              <input
                ...
                id="password" className="form-input w-full" type="password" autoComplete="on" required />
            </div>
            <div>
              ...
              <select
                ...
                id="referrer" className="form-select text-sm py-2 w-full" required>
